...
def EditEntry():
    indexSought = GetContactIndex(contactList)
    get_name = input("Please enter the new contact name: ")
    contactList[indexSought].name = get_name
    get_number = input("Please enter the new contact number: ")
    contactList[indexSought].number = get_number
    print(contactList[indexSought].name)
    print(contactList[indexSought].number)
